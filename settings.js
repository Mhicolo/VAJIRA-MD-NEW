...
SESSION_ID: process.env.SESSION_ID === VAJIRA-MD=XQ1znCjR#Er2Fq7nOv2m2IoMdBQcJVGDbo_7lI4_6BgR0djkMr3E ? '' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === 2348035936169 ? '' : process.env.OWNER_NUMBER,   
